...
#### [The Peeragogy Project](/the_peeragogy_project/)
...
#### BACK [5PH1NX](/5ph1nx/) pattern + analysis                               :handbook:
- Catch up with David about Open Source Learning
#### BACK [Peeragogy in action](/action/) pattern + analysis                  :handbook:
#### BACK [SWATS](/swats/) pattern + analysis                                :handbook:
#### BACK [SOLE](/sole/) pattern + analysis                                 :handbook:
#### BACK [A meeting with the Pro Vice-Chancellor](/a_meeting_with_the_pro_vice_chancellor/) pattern + analysis :handbook:
#### BACK [Collaborative Explorations](/collab-ex/) pattern + analysis           :handbook:
#### BACK [Coworking Story](/coworking-story/) pattern + analysis                      :handbook:
