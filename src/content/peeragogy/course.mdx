...
One of the reasons for writing the [Peeragogy Handbook v4](/peeragogy_handbook_v4/) is that we
...
called [Peeragogy in action](/action/), but it didn’t seem to catch on.  So we
...
- For now “course” is [one of the tags](https://peeragogy.org/tags) used on peeragogy.org, but it should probably develop into its own pattern.
