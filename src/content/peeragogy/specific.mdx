...
><img src="/static/images/difficulty.png" alt="" /> *Difficulty*: bringing about meaningful change is often hard work.
><img src="/static/images/inertia.png" alt="" /> *Inertia*: when things are hard we may feel stuck, wring our hands, or preach to the choir.
...
specific.  Maintaining a project [Roadmap](/roadmap/) can help keep track of the
...
steps.[fn:3] The [Pattern Audit Routine](/pattern_audit/) can help make these "what's
next" steps concrete.
...
steps’.  Here’s ours:
- [Emergent Roadmap](/distributed_roadmap/)
...
[fn:2] In the January, 2013, plenary session,
       [Independent Publishers of New England](http://ipne.org) (IPNE)
