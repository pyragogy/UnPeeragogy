...
context
In "[Effective Grading: A Tool for Learning and Assessment](http://books.google.com/books?id=EJxy06yX_NoC&printsec=frontcover&source=gbs_atb#v=onepage&q&f=false)," Barbara E. Walvoord and
...
- [Researching Peeragogy](/researching_peeragogy/) talks about how students (and others) can do research on learning.

## Technologies
- [Technologies](/technologies/) is relevant in relation to figuring out if you have the right tool for the job.
