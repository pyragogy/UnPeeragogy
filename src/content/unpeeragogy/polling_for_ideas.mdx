---
title: "Decostruzione: Polling For Ideas"
...
---
Questo è lo spazio per la controparte Unpeeragogy di "Polling For Ideas". Qui la teoria viene smontata, il pattern viene decostruito, e la realtà operativa prende il sopravvento.
